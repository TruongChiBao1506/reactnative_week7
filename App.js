...
import ScreenWelcomCafe from './ScreenWelcomCafe'
import ScreenShop from './ScreenShop'
import ScreenDrink from './ScreenDrink'
...
const App = () => {
    return (
        ...
        <NavigationContainer>
            <Stack.Navigator screenOptions={{ headerShown: false }}>
                <Stack.Screen name="ScreenWelcomCafe" component={ScreenWelcomCafe} />
                <Stack.Screen name="ScreenShop" component={ScreenShop} />
                <Stack.Screen name="ScreenDrink" component={ScreenDrink} />
